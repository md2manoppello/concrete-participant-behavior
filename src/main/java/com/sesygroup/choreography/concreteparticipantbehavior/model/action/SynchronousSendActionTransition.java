 ...
 *
 */
public class SynchronousSendActionTransition extends Transition implements Serializable {
   private static final long serialVersionUID = -6317428078261927115L;
   private OutputMessage outputMessage;

   public SynchronousSendActionTransition() {
      super();
      outputMessage = null;
   }

   public SynchronousSendActionTransition(final State sourceState, final State targetState,
   ...
   public boolean equals(final Object obj) {
      ...
      SynchronousSendActionTransition other = (SynchronousSendActionTransition) obj;
   ...
   public String toString() {
      return "(" + sourceState + ", " + outputMessage + ", " + targetState + ", synchronous)";
   }
}
