 ...
 *
 */
public class SynchronousReceiveActionTransition extends Transition implements Serializable {
   private static final long serialVersionUID = -458101140044072490L;
   private InputMessage inputMessage;

   public SynchronousReceiveActionTransition() {
      super();
      inputMessage = null;
   }

   public SynchronousReceiveActionTransition(final State sourceState, final State targetState,
   ...
   public boolean equals(final Object obj) {
      ...
      SynchronousReceiveActionTransition other = (SynchronousReceiveActionTransition) obj;
   ...
   public String toString() {
      return "(" + sourceState + ", " + inputMessage + ", " + targetState + ", synchronous)";
   }
}
